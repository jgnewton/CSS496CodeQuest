...
function Cannon(spriteTexture) {
    this.cannon = new SpriteRenderable(spriteTexture);
    //this.base.setColor([1, 1, 1, 0]);
    //this.base.getXform().setPosition(50, 40);
    this.cannon.getXform().setSize(20, 20);
    this.cannon.setElementPixelPositions(0, 217, 263, 422);
    
    this.base = new SpriteRenderable(spriteTexture);
    this.base.getXform().setSize(20, 20);
    this.base.setElementPixelPositions(0, 70, 95, 222);
